...
P("distinction", 1, "peur-ou-anxiete", "Peur ou anxiété ?",
  ...
  "Chez toi, laquelle des deux parle le plus fort ?",
...
P("comprendre", 2, "comprendre-colere", "La colère",
  ...
  [
   T("À QUOI ELLE SERT", "Défendre ce qui compte",
     "La colère se lève quand une limite est franchie ou qu’une valeur importante est bafouée : une injustice, un manque de respect, une promesse trahie. Elle ne cherche pas le conflit — elle défend un territoire."),
...
P("distinction", 2, "colere-ou-agressivite", "Colère ou agressivité ?",
  ...
  [
   T("LA PREMIÈRE", "La colère",
     "C’est un signal intérieur : une limite importante vient d’être franchie. On peut la ressentir intensément… et ne blesser personne. Ressentir n’a jamais fait de mal à quiconque.", vign="colere"),
   ...
   D("D’où la différence",
     ...
     "Interdire la colère ne rend pas doux — ça rend muet. Et ce qu’on tait finit par déborder ailleurs, souvent sur les mauvaises personnes."),
  ],
  "On t’a appris à écouter ta colère — ou à la taire ?",
...
P("distinction", 4, "ruminer-ou-reparer", "Ruminer ou réparer ?",
  ...
  "Ta culpabilité répare — ou elle tourne ?",
...
P("pratique", 4, "la-reparation-en-une-phrase", "La réparation\nen une phrase",
  ...
  [
   T("POURQUOI ÇA MARCHE", "Une vraie excuse ne plaide pas",
     "La plupart des excuses échouent parce qu’elles plaident : « je suis désolé, mais j’étais fatigué ». Le « mais » annule tout ce qui précède. Une excuse qui répare reconnaît l’acte, nomme l’effet, et propose — c’est tout."),
...
P("distinction", 5, "tristesse-ou-depression", "Tristesse ou dépression ?",
  ...
  [
   ...
   D("D’où la différence",
     ...
     "Si le gris dure depuis plus de deux semaines sans un seul moment de plaisir, ce n’est plus une histoire de volonté : c’est le moment d’en parler à un médecin ou à un psy."),
  ],
  "Chez toi, c’est une vague qui passe — ou un fond qui s’installe ?",
  "Confondre les deux fait des dégâts dans les deux sens : on dramatise une tristesse normale, ou on banalise une vraie dépression. Voici la différence qui compte.",
...
P("distinction", 6, "jalousie-ou-envie", "Jalousie ou envie ?",
  ...
  "Chez toi, c’est plutôt le triangle — ou le duo ?",
...
P("pratique", 6, "traduire-le-pincement", "Traduire\nle pincement",
  ...
  [
   ...
   T("LE DÉTAIL QUI CHANGE TOUT", "Allège la source",
     "Repère le compte, l’appli ou la conversation qui pique le plus — et coupe-le sept jours. Pas pour fuir : pour vérifier à quel point le pincement s’apaise quand on cesse de le suralimenter."),
  ],
...
P("distinction", 7, "joie-ou-bonheur", "Joie ou bonheur ?",
  ...
  "Tu attends le climat parfait — ou tu prends la météo du jour ?",
...
P("pratique", 7, "la-joie-notee", "La joie notée",
  ...
  [
   ...
   T("LE DÉTAIL QUI CHANGE TOUT", "La précision fait la différence",
...
P("distinction", 8, "passion-ou-tendresse", "Passion ou tendresse ?",
  ...
  "Tu sais reconnaître l’amour quand il baisse la voix ?",
...
P("comprendre", 9, "comprendre-gratitude", "La gratitude",
  ...
  [
   T("À QUOI ELLE SERT", "Mesurer ce qui t’est donné",
     "La gratitude est un déplacement d’attention : du manque vers le présent, de ce qui rate vers ce qui tient. Ce n’est pas de la naïveté — c’est un correctif au biais qui ne voit que les problèmes."),
...
P("distinction", 9, "gratitude-ou-dette", "Gratitude ou dette ?",
  ...
  [
   T("LA PREMIÈRE", "La gratitude",
     "« Ça compte pour moi. » Elle accueille ce qui est offert, le savoure, et donne envie de rendre — librement, sans obligation. Elle allège celui qui la ressent et touche celui qui la reçoit.", vign="gratitude"),
   ...
   D("D’où la différence",
     ...
     "Si recevoir t’est difficile, c’est peut-être que tout arrive chez toi étiqueté « dette ». Recevoir sans rembourser tout de suite, c’est laisser à l’autre le plaisir d’avoir donné."),
  ],
  "Tu sais recevoir — ou tu rembourses tout de suite ?",
...
P("distinction", 10, "fierte-ou-arrogance", "Fierté ou arrogance ?",
  ...
  "Tu t’autorises à être fier·e — ou tu t’en méfies ?",
...
P("pratique", 10, "la-minute-de-credit", "La minute\nde crédit",
  ...
  [
   ...
   T("LE DÉTAIL QUI CHANGE TOUT", "Compte aussi les jours moyens",
     "Traverser une journée difficile, dire non, demander de l’aide : ça compte. La fierté réservée aux exploits meurt de faim — celle qui accueille l’ordinaire nourrit tous les jours."),
  ],
...
P("distinction", 11, "serenite-ou-indifference", "Sérénité ou indifférence ?",
  ...
  "Ton calme à toi — habité, ou débranché ?",
...
P("comprendre", 12, "comprendre-surprise", "La surprise",
  ...
  [
   ...
   T("SA NATURE", "Un carrefour neutre",
     "La surprise ne dure qu’un instant, puis elle se transforme : en joie, en peur ou en colère, selon ce qui arrive. Elle n’est ni agréable ni désagréable — c’est l’aiguillage, pas la destination."),
...
P("distinction", 12, "surprise-ou-sursaut", "Surprise ou sursaut ?",
  ...
  "Ton seuil d’alarme est réglé comment, ces temps-ci ?",
...
P("distinction", 13, "emotion-ou-humeur", "Émotion ou humeur ?",
  ...
  "Aujourd’hui — c’est une émotion qui te parle, ou une humeur qui te colore ?",
  ...
  "#humeur #introspection", emos=["joie", "tristesse"]),
...
P("pratique", 13, "la-meteo-interieure", "La météo\nintérieure",
  ...
  [
   ...
   E("COMMENT FAIRE", "Une minute, où tu veux",
     [("Quelle est la dominante ?", "là, maintenant : plutôt anxiété, joie, colère, fatigue ? Un mot suffit."),
      ...
      ("Quel besoin dessous ?", "être rassuré·e, reconnu·e, tranquille, relié·e ? Le besoin indique l’action.")]),
  ...
  "Si tu faisais le point complet — les 14 d’un coup ?",
