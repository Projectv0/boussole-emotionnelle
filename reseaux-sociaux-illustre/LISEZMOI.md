...
| **prompts/00-style.md** | le suffixe de style — la pièce qui garantit la cohérence des 287 illustrations. |
...
| **illustrations/** | les 287 images sorties de Nano Banana. Hors dépôt (206 Mo). |
...
3. **Générer les 287 illustrations avant d'en avoir composé une seule.** Une passe de validation
