...
*(La bulle «&nbsp;T’étais où ?&nbsp;» est dessinée par l'assembleur — ne la demande pas à Nano Banana.)*
...
*(La bulle «&nbsp;J’ai peur de te perdre.&nbsp;» est dessinée par l'assembleur — ne la demande pas à Nano Banana.)*
...
```bash
python3 assembleur.py 28
```

Les diapositives et la légende arrivent dans `sortie/28-jalousie-dans-le-couple/`.
