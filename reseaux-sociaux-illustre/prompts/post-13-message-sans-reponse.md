...
*(La bulle «&nbsp;Et si c’était moi, le problème ?&nbsp;» est dessinée par l'assembleur — ne la demande pas à Nano Banana.)*
...
```bash
python3 assembleur.py 13
```

Les diapositives et la légende arrivent dans `sortie/13-message-sans-reponse/`.
