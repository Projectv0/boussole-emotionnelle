...
*(La bulle «&nbsp;Je sais, je suis une catastrophe !&nbsp;» est dessinée par l'assembleur — ne la demande pas à Nano Banana.)*
...
## 10. `carnet-cuisine.png`

> Je suis ridicule — Mardi, j’ai bafouillé deux minutes
...
```bash
python3 assembleur.py 6
```

Les diapositives et la légende arrivent dans `sortie/06-deguisements-honte/`.
